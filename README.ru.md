...
> **Твой компаньон на рабочем столе.** Клодик — пиксельный ИИ-агент, который живёт прямо на экране, разговаривает с тобой по-русски и реально делает вещи — открывает программы, печатает текст, гуглит, двигает мышкой и запоминает твои привычки.

<p align="center">
  <img src="public/claude.png" width="128" alt="Спрайт Клодика">
</p>
...
| 🗣️ **Только русский** | Говорит как человек в мессенджере — коротко, по делу, с сарказмом |
| 🧠 **Groq LLM** | Работает на `llama-3.3-70b-versatile` — быстрая, умная, 70B параметров |
